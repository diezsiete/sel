<template>
    <div class="main-container">
        <div class="title">
            <original-filename-editable :archivo="archivo"></original-filename-editable>
...
<script>
    ...
    import OriginalFilenameEditable from "./OriginalFilenameEditable";
    export default {
        components: {
            OriginalFilenameEditable
        },
        name: "ArchivoDetail",
        computed: mapState({
            archivo: 'archivoSelected',
