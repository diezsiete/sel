...
final class Version20200331063129 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE napi_se_certificado_ingresos');
    }
}
